...
<title>Genetic code for vessel capabilities and behavior patterns</title>
...
h1{font-size:3rem;font-weight:700;margin-bottom:1rem;color:#e11d48}
...
.card{background:#1e293b;border-radius:12px;padding:1.5rem;border-left:4px solid #e11d48}
.card h3{color:#e11d48;margin-bottom:0.5rem}
.footer{margin-top:4rem;text-align:center;color:#64748b;font-size:0.9rem}
.footer a{color:#e11d48;text-decoration:none}
</style></head><body><div class="container">
<div class="hero"><h1>Agent Dna</h1>
<p class="subtitle">Genetic code for vessel capabilities and behavior patterns.</p></div>
<div class="features">
<div class="card"><h3>Capability genome</h3><p>behavior traits,  inheritance patterns,  mutation tracking</p></div>
</div>
<div class="footer">
